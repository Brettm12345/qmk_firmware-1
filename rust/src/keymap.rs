...
keymaps!(
    ...
    layer_cnt => 4,
    layer!(  // layer 0
        r!(     '`'     | 1  | 2  | 3 | 4 | 5 |  6  | 7 | 8 | 9 |   0   |  -  | =  |BSLS |KC_GRV  ),
        r!( [TAB &HYPR_T] | Q  | W  | E | R | T |  Y  | U | I | O |   P   | '[' |']' |KC_RBRC |KC_BSPC ),
    ...
    layer!( // Prog
        r!( CK::FLASH | F1 | F2 | F3 | F4 | F5 | F6 | F7 | F8 | F9 | F10 | F11 | F12 |xxxxx|xxxxx )
        r!((KC_TAB)       | CK::BIND | "@" | CK::BIND_FLIPPED | CK::FAT_ARROW | CK::OR | CK)
